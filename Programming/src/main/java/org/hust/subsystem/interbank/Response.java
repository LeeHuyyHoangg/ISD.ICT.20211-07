...
import org.hust.common.exception.InternalServerErrorException;
import org.hust.common.exception.InvalidCardException;
import org.hust.common.exception.InvalidTransactionAmountException;
import org.hust.common.exception.InvalidVersionException;
import org.hust.common.exception.NotEnoughBalanceException;
import org.hust.common.exception.NotEnoughTransactionInfoException;
import org.hust.common.exception.PaymentException;
import org.hust.common.exception.SuspiciousTransactionException;
...
public class Response {
  ...
  PaymentTransaction getPaymentTransaction() throws PaymentException, UnrecognizedException {
    switch (errorCode) {
      case "00": break; 
      case "01": throw new InvalidCardException(); 
      case "02": throw new NotEnoughBalanceException();
      case "03": throw new InternalServerErrorException(); 
      case "04": throw new SuspiciousTransactionException(); 
      case "05": throw new NotEnoughTransactionInfoException(); 
      case "06": throw new InvalidVersionException(); 
      case "07": throw new InvalidTransactionAmountException();
